...
from:https://github.com/kuangliu/pytorch-cifar/blob/master/models/efficientnet.py
'''
import torch
...
class SE(nn.Module):
    ...
    def __init__(self, in_channels, se_channels):
        ...
        self.se1 = nn.Conv1d(in_channels, se_channels,
                             kernel_size=1, bias=True)
        self.se2 = nn.Conv1d(se_channels, in_channels,
                             kernel_size=1, bias=True)
